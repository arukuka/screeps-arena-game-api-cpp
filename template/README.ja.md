...
何が未実装かは `node_modules/screeps-arena-game-api-cpp/sim/FIDELITY.ja.md` に書いてある。
細部を詰める前に読むこと。

ライブラリ側のドキュメント（[screeps-arena-game-api-cpp](https://github.com/arukuka/screeps-arena-game-api-cpp)）:

- [docs/ARENA-RUNTIME.ja.md](https://github.com/arukuka/screeps-arena-game-api-cpp/blob/main/docs/ARENA-RUNTIME.ja.md)
  — Arena サンドボックスの癖、ビルドフラグの根拠、**起動に失敗したときの読み方**
- [docs/DESIGN.ja.md](https://github.com/arukuka/screeps-arena-game-api-cpp/blob/main/docs/DESIGN.ja.md)
  — 定数の扱い、オブジェクト表現の選択
- [docs/CONTRIBUTING.ja.md](https://github.com/arukuka/screeps-arena-game-api-cpp/blob/main/docs/CONTRIBUTING.ja.md)
  — API の増やし方
